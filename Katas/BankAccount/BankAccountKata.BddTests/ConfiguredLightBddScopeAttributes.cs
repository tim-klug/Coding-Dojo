using BankAccountKata.BddTests;
...
namespace BankAccountKata.BddTests
{
    /// <summary>
    ...
    internal class ConfiguredLightBddScopeAttribute : LightBddScopeAttribute
    {
        ...
        protected override void OnConfigure(LightBddConfiguration configuration)
        {
            configuration
                ...
                .Clear()
                .Add(new ReportFileWriter(new XmlReportFormatter(), "~" + System.IO.Path.DirectorySeparatorChar + "Reports" + System.IO.Path.DirectorySeparatorChar + "FeaturesReport.xml"))
